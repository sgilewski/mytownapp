...
import { loadFeed, setPrimaryTown, toggleBusinessFavorite, toggleOfferSave, type TownFeed } from "@/lib/data";
...
const empty: TownFeed = { towns: [], town: null, businesses: [], offers: [], events: [], favoriteIds: [], savedOfferIds: [] };
